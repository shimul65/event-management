    ...
    return (
        <div className="py-8 md:py-14">
            <h2 data-aos="fade-down"
                ...
                data-aos-duration="1300" className=" text-3xl md:text-5xl font-extrabold text-center">Gallery
            </h2>
            ...
            <p data-aos="zoom-in" data-aos-easing="linear"
                data-aos-duration="1300" className="text-center text-[#a3a3a6] text-sm">OUR RECENT PROJECTS</p>
